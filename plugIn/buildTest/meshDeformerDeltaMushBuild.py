...
nodeType       = 'meshDeformerDeltaMush'  
releaseFolder = ['Debug','Release']
pathNodeCpp    = 'D:/mcantat_BDD/projects/code/maya/c++/mayaNode/meshDeformerDeltaMush/Build/{}/meshDeformerDeltaMush.mll'.format( releaseFolder[releaseMode] )
pathNode   = [ pathNodePython , pathNodeCpp ][useNodeCpp]
#__________________________ BUILD TEST INFO
lodSuffixs = [ 'Low' , 'High' ]
pathBuildTest = 'D:/mcantat_BDD/projects/nodeTest/meshDeformerDeltaMushBuildTest{}.ma'.format(lodSuffixs[highPoly])
...
mc.makePaintable(  "meshDeformerDeltaMush" , "weights" ,attrType = "multiFloat" , sm ="deformer" )
