...
rwi = readWriteInfo()
rwi.mayaScene_load( 'D:/mcantat_BDD/projects/quadriped/assets/lion/maya/scenes/lion_rigSkeleton.ma' , open = True )
#___________________________________________________________________________LOAD RIG BASE
...
path = 'D:/mcantat_BDD/projects/quadriped/assets/lion/maya/scenes/lion_utils_rigBoundBConstraints.xml'
...
from python.utils.utilsRigPuppet import *
reload( python.utils.utilsRigPuppet )
path = 'D:/mcantat_BDD/projects/quadriped/assets/lion/maya/scenes/lion_utils_rigBoundBSkinning.xml'
...
mesh = rigPuppet_combineMesh(  mc.ls( '*_GEO' , type = 'transform' ) , "lion_GEO" )
...
rwi.mayaScene_save( 'D:/mcantat_BDD/projects/quadriped/assets/lion/maya/scenes/lion_rigBoundB.ma' )
#___________________________________________________________________________SAVE TO SKELETON
